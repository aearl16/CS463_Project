...
namespace HelloWorld.Controllers
{
    public class RecordsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.WorkoutID = new SelectList(db.Workouts, "ID", "WorkoutType");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ID,AthleteID,WorkoutID,WorkoutTime,Distance,Steps,HeartRate,WorkoutDate,GPSLog")] Record record)
        {
            ...
            ViewBag.AthleteID = new SelectList(db.Athletes, "ID", "FullName", record.AthleteID);
            ViewBag.WorkoutID = new SelectList(db.Workouts, "ID", "WorkoutType", record.WorkoutID);
            return View(record);
        }
