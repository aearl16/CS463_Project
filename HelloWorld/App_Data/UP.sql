...
-- Records: table name left singlular for DAL
CREATE TABLE dbo.Record
(
	ID			INT NOT NULL,
	AthleteID	INT NOT NULL,
	WorkoutID	INT NOT NULL,
	WorkoutTime	NVARCHAR(30),	--Time in hrs:mins:secs

	Distance	FLOAT, --Allows for fractional miles
	Steps		INT, 
	HeartRate	INT, --IN BPM
	WorkoutDate	DATETIME NOT NULL,
	GPSLog			NVARCHAR(255), -- Unknown Data left as VARCHAR
...
--Testing query
SELECT FullName, WorkoutTime, Distance, HeartRate 
	FROM dbo.Athlete as x JOIN dbo.Record as y 
	ON x.ID = y.AthleteID
	WHERE x.ID = 1; 